...
extension BasePageCollectionCell {
    ...
    fileprivate func createShadowViewOnView(_ view: UIView?) -> UIView? {
        ...
        // create constraints
        let frontViewlayoutAttribs:[(NSLayoutConstraint.Attribute, CGFloat)] =  [(NSLayoutConstraint.Attribute.width, 0.8), (NSLayoutConstraint.Attribute.height, 0.9)]
        
        for info: (attribute: NSLayoutConstraint.Attribute, scale: CGFloat) in frontViewlayoutAttribs {
        ...
        let contentViewlayoutAttribs:[(NSLayoutConstraint.Attribute, CGFloat)] =  [(NSLayoutConstraint.Attribute.centerX, 0), (NSLayoutConstraint.Attribute.centerY, 30)]
        
        for info: (attribute: NSLayoutConstraint.Attribute, offset: CGFloat) in contentViewlayoutAttribs {
